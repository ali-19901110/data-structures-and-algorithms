...
const addValues = (arr) => {
  // Solution code here...
  const newValue = arr.reduce((acc , value , indx)=>{
    return acc +value;
 },0);
 return newValue;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  const newpr = arr.reduce((acc, value , idx)=>
  {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const conElement = arr.reduce((ac , value , idx)=> {
    return ac+1;
  },0)
  return conElement;
};
...
const returnNames = (arr) => {
  // Solution code here...
  const nameChar = arr.reduce((acc, value, idx)=> {
    acc.push(value.name);
    return acc;
  }, [])
  return nameChar;
...
const reversedString = (str) => {
  ...
  const nRevStr = splitedStr.reduce((ac,value,idx)=>{
    return value+ac;
  },'')
  return nRevStr;
};
